...
public class SQLiteHandler extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_USER + "("
                ...
                + KEY_EMAIL + " TEXT UNIQUE," + KEY_PASSWORD + " TEXT," + KEY_UID + " TEXT UNIQUE,"
                + KEY_CREATED_AT + " TEXT" + ")";
     ...
     * */
    public void addUser(String name, String email, String pass ,String uid, String created_at) {
    ...
    //Seleccionamos los datos del usuario cuyo correo corresponda
    public HashMap<String, String> getUserDetail(String email) {
